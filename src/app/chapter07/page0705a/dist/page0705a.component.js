...
exports.Page0705aComponent = void 0;
var core_1 = require("@angular/core");
var Page0705aComponent = /** @class */ (function () {
    function Page0705aComponent() {
        var _this = this;
    ...
    Page0705aComponent.prototype.ngOnInit = function () {
        this.controls.reDraw();
    };
    Page0705aComponent.prototype.onRender = function (timer) {
        if (this.controls.rotate) {
            this.rotation.y += timer.delta * 20;
            this.rotation.x = this.rotation.z = this.rotation.y;
        }
    };
    Page0705aComponent = __decorate([
        core_1.Component({
    ...
    return Page0705aComponent;
}());
exports.Page0705aComponent = Page0705aComponent;
