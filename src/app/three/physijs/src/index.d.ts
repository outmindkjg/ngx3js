...
{
    constructor(geometry: THREE.Geometry | THREE.BufferGeometry, material?: THREE.Material, mass?: number);
...
{
    constructor(geometry: THREE.Geometry | THREE.BufferGeometry, material: THREE.Material, mass?: number, xdiv?: number, ydiv?: number);
}
...
export class Vehicle
{
    ...
    addWheel(wheel_geometry: THREE.Geometry | THREE.BufferGeometry, wheel_material: THREE.Material, connection_point: THREE.Vector3, wheel_direction: THREE.Vector3, wheel_axle: THREE.Vector3, suspension_rest_length: number, wheel_radius: number, is_front_wheel: boolean, tuning?: VehicleTuning): void;
