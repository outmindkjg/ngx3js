							...
							default:
								if (mesh instanceof THREE.Scene) {
									switch (materialType.toLowerCase()) {
										...
										case 'background':
											const backgroundTexture: THREE.Texture = material['map'];
										...
										case 'environment':
											const environmentTexture: THREE.Texture = material['map'];
											if (ThreeUtil.isNotNull(environmentTexture)) {
												mesh.environment = environmentTexture;
											} else {
												const environmentTextureEnv: THREE.Texture = material['envMap'];
