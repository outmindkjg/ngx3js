...
export abstract class AbstractObject3dComponent extends AbstractTweenComponent implements OnInit, OnChanges, AfterContentInit, OnDestroy {
	 ...
	 */
	@Input() protected geometry: AbstractGeometryComponent | THREE.BufferGeometry | any = null;

	/**
	 * The material of mesh
	 */
	@Input() protected material: AbstractMaterialComponent | THREE.Material = null;

	/**
	 * The material of mesh is array
	 */
	@Input() protected materialIsArray: boolean = null;
