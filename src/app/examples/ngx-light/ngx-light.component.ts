	...
	constructor() {
		super(
			...
			[
				...
				{ name: 'ambientLight', type: 'folder' , control : 'ambientLight' , children : [
					{ name : 'enable', type : 'checkbox'},
					{ name : 'color', type : 'color'},
					{ name : 'intensity', type : 'number', min : 0, max : 1.5, step : 0.01},
				]},
				{ name: 'directionalLight', type: 'folder' , control : 'directionalLight' , children : [
					{ name : 'enable', type : 'checkbox'},
					{ name : 'color', type : 'color'},
				...
				{ name: 'spotLight', type: 'folder' , control : 'spotLight' , children : [
					{ name : 'enable', type : 'checkbox'},
					{ name : 'color', type : 'color'},
					{ name : 'castShadow', type : 'checkbox'},
					{ name : 'intensity', type : 'number', min : 0, max : 1.5, step : 0.01},
				...
				{ name: 'hemisphereLight', type: 'folder' , control : 'hemisphereLight' , children : [
					{ name : 'enable', type : 'checkbox'},
				...
				{ name: 'rectAreaLight', type: 'folder' , control : 'rectAreaLight' , children : [
					{ name : 'enable', type : 'checkbox'},
					{ name : 'color', type : 'color'},
					{ name : 'intensity', type : 'number', min : 0, max : 1.5, step : 0.01},
				...
				{ name: 'lightTarget', type: 'folder' , control : 'lightTarget' , children : [
					{ name : 'x', type : 'number', min : -30, max : 30, step : 0.1},
					{ name : 'y', type : 'number', min : -30, max : 30, step : 0.1},
					{ name : 'z', type : 'number', min : -30, max : 30, step : 0.1},
				]}
