			...
			[
				{
					...
					children: [
						...
						{ name: 'shadowMapType', type: 'select', select: ['BasicShadowMap', 'PCFShadowMap', 'PCFSoftShadowMap','VSMShadowMap'] },
						{ name: 'toneMapping', type: 'select', select: ['ToneMapping', 'LinearToneMapping', 'ReinhardToneMapping','CineonToneMapping','ACESFilmicToneMapping','NoToneMapping'] },
						{ name: 'toneMappingExposure', type: 'number', min : 0, max : 1, step : 0.1 },
					],
				},
				{
					name: 'controler',
					...
					control: 'controler',
					children: [
						{ name: 'type', type: 'select', select: ['FlyControls', 'FirstPersonControls', 'DeviceOrientationControls','ArcballControls','PlaneControls','OrbitControls'] },
						{ name: 'enablePan', type: 'checkbox' },
						{ name: 'enableDamping', type: 'checkbox' },
						{ name: 'minDistance', type: 'number', min : 0, max : 30, step : 0.1 },
						{ name: 'maxDistance', type: 'number', min : 20, max : 300, step : 0.1 },
					],
				},
			],
