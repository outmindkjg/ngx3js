...
export class WebglMaterialsBlendingCustomComponent extends BaseComponent<{
  ...
  constructor() {
    super({
      ...
      { name : 'foreground' , type : 'select' , select : {
      ...
      { name : 'background' , type : 'select' , select : [
        'disturb',
        'transparent1',
        'transparent2',
        'crate',
        ...
        'water',
        'cloud',
      ], change : () => { this.setBackground(this.controls.background); }},
      { name : 'equation' , type : 'select' , select : [
        'Add',
        'Subtract',
        'ReverseSubtract',
        'Min',
  ...
  backgrounds : {
    ...
    disturb : { image : 'textures/disturb.jpg', repeatX : 8, repeatY : 4, wrapS : 'Repeat', wrapT : 'Repeat' },
    transparent1 : { program : this.canvasProgram1, repeatX : 128, repeatY : 64, wrapS : 'Repeat', wrapT : 'Repeat' },
    transparent2 : { program : this.canvasProgram2, repeatX : 128, repeatY : 64, wrapS : 'Repeat', wrapT : 'Repeat'},
    crate : { image : 'textures/crate.gif', repeatX : 32, repeatY : 16, wrapS : 'Repeat', wrapT : 'Repeat'},
    lavatile : { image : 'textures/lava/lavatile.jpg', repeatX : 8, repeatY : 4, wrapS : 'Repeat', wrapT : 'Repeat'},
    water : { image : 'textures/water.jpg', repeatX : 8, repeatY : 4, wrapS : 'Repeat', wrapT : 'Repeat'},
    cloud : { image : 'textures/lava/cloud.png', repeatX : 2, repeatY : 1, wrapS : 'Repeat', wrapT : 'Repeat'},
  }
