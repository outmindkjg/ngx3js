...
export class WebglGeometryNurbsComponent extends BaseComponent<{}> {
  ...
  ngOnInit() {
    ...
    const nurbsCurve = new NURBSCurve( nurbsDegree, nurbsKnots, nurbsControlPoints, null, null );
    ...
    this.nurbsSurface = new NURBSSurface( degree1, degree2, knots1, knots2, nsControlPoints );
  }
