...
export class WebglLoaderMd2Component extends BaseComponent<{
  ...
  constructor() {
    super({
      ...
      { name : 'animation', type : 'select', select : ["stand", "run", "attack", "pain", "jump", "flip", "salute", "taunt", "wave", "point", "crstand", "crwalk", "crattack", "crpain", "crdeath", "death"]},
      { name : 'weapon', type : 'select', select : [
        "weapon",
        "w_bfg",
        "w_blaster",
        "w_chaingun",
