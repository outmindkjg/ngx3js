...
export class WebglMaterialsComponent extends BaseComponent<{}> {
  ...
  ngOnInit() {
    ...
    this.addMeshInfo(2, 'MeshPhong', { color: 0xdddddd, specular: 0x009900, shininess: 30, flatShading: true });
    this.addMeshInfo(3, 'MeshNormal', {  });
    this.addMeshInfo(4, 'MeshBasic', { color: 0xffaa00, transparent: true, blending: 'Additive' });
    this.addMeshInfo(5, 'MeshLambert', { color: 0xdddddd });
    this.addMeshInfo(6, 'MeshPhong', { color: 0xdddddd, specular: 0x009900, shininess: 30, map: true, transparent: true });
    ...
    this.addMeshInfo(10, 'MeshLambert', { color: 0x666666, emissive: 0xff0000 });
    this.addMeshInfo(11, 'MeshPhong', { color: 0x000000, specular: 0x666666, emissive: 0xff0000, shininess: 10, opacity: 0.9, transparent: true });
  ...
  onRender(timer : RendererTimer) {
    ...
    if (this.mesh !== null) {
      ...
      material1.emissive.setHSL( 0.54, 1, 0.35 * ( 0.5 + 0.5 * Math.sin( 35 * elapsedTime ) ) );
      material2.emissive.setHSL( 0.04, 1, 0.35 * ( 0.5 + 0.5 * Math.cos( 35 * elapsedTime ) ) );
