...
export class Css3dMoleculesComponent extends BaseComponent<{
  ...
  constructor() {
    super({
      ...
      { name : 'atoms' , type : 'checkbox', change : () => { this.changeVisible(); }},
      { name : 'bones' , type : 'checkbox', change : () => { this.changeVisible(); }},
      { name : 'labels' , type : 'checkbox', change : () => { this.changeVisible(); }}
    ]);
  }
