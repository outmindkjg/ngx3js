		...
		super(
			...
			[
				...
				},
				{
					...
					control: 'camera',
					children: [
						{ name: 'type', type: 'select', select: ['PerspectiveCamera', 'OrthographicCamera'], change : () => { this.changeCamera(); } },
				...
				},
				{
					...
					children: [
						...
						{ name: 'viewportType', type: 'select', select : ['renderer','viewoffset','camera'] },
