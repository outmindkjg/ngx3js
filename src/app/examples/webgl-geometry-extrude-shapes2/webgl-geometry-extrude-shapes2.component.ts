...
export class WebglGeometryExtrudeShapes2Component extends BaseComponent<{
  ...
  constructor() {
    super({
      ...
      { name :'Taipei City' , type : 'folder', isOpen : true, control: 'taipei', children : [
        { name : 'visible', type : 'checkbox', change : () => {
          this.changeMapInfo(0, this.controls.taipei);
        }},
        { name : 'depth', type : 'number', min : 19, max : 25, step : 0.5, change : () => {
          this.changeMapInfo(0, this.controls.taipei);
        }},
      ...
      { name :'Keelung City' , type : 'folder', isOpen : true, control: 'keelung', children : [
        { name : 'visible', type : 'checkbox', change : () => {
  ...
  changeMapInfo(idx : number, info : { visible : boolean, color : number, depth : number}) {
