...
export class WebglLoaderSvgComponent extends BaseComponent<{
  ...
  constructor() {
    super({
      ...
      { name : 'currentURL', type : 'select',  title : 'SVG File',select : {
      ...
      { name : 'strokesWireframe' , type : 'checkbox', title : 'Wireframe strokes'},
      { name : 'fillShapesWireframe' , type : 'checkbox', title : 'Wireframe fill shapes'},
    ]);
  }
