...
export class WebglGeometryExtrudeSplinesComponent extends BaseComponent<{
  ...
  constructor() {
    super({
      ...
      { name : 'Geometry' , type : 'folder', isOpen : true, children : [
        { name : 'spline' , type : 'select', select : [
          'GrannyKnot',
          'HeartCurve',
          'VivianiCurve',
          'KnotCurve',
        ...
        { name : 'extrusionSegments', type : 'number', min : 50, max : 500, step : 50},
        { name : 'radiusSegments', type : 'number', min : 2, max : 20, step : 1},
        { name : 'closed', type : 'checkbox'},
      ]},
      { name : 'Camera' , type : 'folder', isOpen : true, children : [
        { name : 'animationView', type : 'checkbox'},
        { name : 'cameraSpeed', type : 'number', min : 50, max : 2500, step : 100},
  ...
  pipeSpline = [
    { x : 0, y : 10, z : -10}, { x : 10, y : 0, z : -10},
    { x : 20, y : 0, z : 0}, { x : 30, y : 0, z : 10},
    { x : 30, y : 0, z : 20}, { x : 20, y : 0, z : 30},
    { x : 10, y : 0, z : 30}, { x : 0, y : 0, z : 30},
    { x : -10, y : 10, z : 30}, { x : -10, y : 20, z : 30},
    { x : 0, y : 30, z : 30}, { x : 10, y : 30, z : 30},
    { x : 20, y : 30, z : 15}, { x : 10, y : 30, z : 10},
    { x : 0, y : 30, z : 10}, { x : -10, y : 20, z : 10},
    { x : -10, y : 10, z : 10}, { x : 0, y : 0, z : 10},
    { x : 10, y : -10, z : 10}, { x : 20, y : -15, z : 10},
    { x : 30, y : -15, z : 10}, { x : 40, y : -15, z : 10},
    { x : 50, y : -15, z : 10}, { x : 60, y : 0, z : 10},
    { x : 70, y : 0, z : 0}, { x : 80, y : 0, z : 0},
    { x : 90, y : 0, z : 0}, { x : 100, y : 0, z : 0}
  ];
  ...
  onRender(timer : RendererTimer) {
    ...
    if (this.mesh !== null && this.tubeGeometry !== null && this.cameraHelper !== null && this.splineCamera !== null && this.cameraEye !== null) {
      ...
      if ( ! this.controls.lookAhead ) this.lookAt.copy( this.position ).add( this.direction );
