...
var AppComponent = /** @class */ (function () {
    function AppComponent(router) {
        ...
        this.subscription = this.router.events.subscribe(function (event) {
            if (event instanceof router_1.NavigationEnd) {
                _this.changeRouter(event.urlAfterRedirects || event.url);
            }
        });
    }
    ...
    AppComponent.prototype.changeRouter = function (url) {
        this.menuId = url;
    ...
    AppComponent.prototype.searchFocus = function () {
        this.searchFocused = true;
    };
    AppComponent.prototype.searchKeyUp = function () {
        var filter = this.search.nativeElement.value;
        if (filter != '') {
            this.checkSearch(filter);
        }
    };
    AppComponent.prototype.searchBlur = function () {
    ...
    AppComponent.prototype.searchClear = function () {
        this.search.nativeElement.value = '';
        this.checkSearch('');
    };
    AppComponent.prototype.toggleMinimal = function () {
        this.minimal = !this.minimal;
    };
    AppComponent.prototype.checkSearch = function (filter) {
        var _this = this;
        ...
        var searchMenu = [];
        Object.entries(this.files).forEach(function (_a) {
            var key = _a[0], value = _a[1];
            var children = _this.getSearchChildren(value, filter, key);
    ...
    AppComponent.prototype.checkSearchMenuSelected = function (searchMenu) {
        var _this = this;
        var selectedTop = null;
        searchMenu.forEach(function (menu) {
            var selectedChild = null;
            menu.children.forEach(function (child) {
                child.selected = child.id === _this.menuId;
                if (child.selected) {
                    selectedChild = child;
                }
            });
            if (selectedChild !== null) {
                selectedTop = menu;
                var children_1 = [];
                children_1.push(selectedChild);
                var isFounded_1 = false;
                menu.children.forEach(function (child) {
                    if (isFounded_1) {
                ...
                selectedTop.children = children_1;
            }
        });
        return searchMenu;
    };
    AppComponent.prototype.getSearchChildren = function (menu, keyword, parentId) {
        var _this = this;
        var children = [];
        menu.forEach(function (id) {
            var child = _this.getSearchItem(id, keyword, parentId);
            if (child !== null) {
                children.push(child);
            }
        });
    ...
    AppComponent.prototype.getSearchItem = function (id, keyword, parentId) {
        var tags = this.tags[id] !== undefined ? this.tags[id] : [];
        if (keyword == '' ||
            tags.indexOf(keyword) > -1 ||
            id.indexOf(keyword) > -1) {
            var itemTags_1 = [];
            id.split('_').forEach(function (key) {
                if (parentId !== key && itemTags_1.indexOf(key) === -1) {
                    itemTags_1.push(key);
                }
            });
